...
public class KeyInputManager : MonoBehaviour
{
    ...
    Vector3 thirdPersonContainerPos;
    public bool usingThirdPersonCamera = false;
    ...
    public IEnumerator CalibrationCoroutine()
    {
        ...
        if (usingThirdPersonCamera)
        {
            thirdPersonContainerPos = thirdPersonCameraScript.GetComponent<Transform>().position;
            cameraContainer.SetPositionAndRotation(thirdPersonContainerPos, playerRotation);
        }
        else
