...
public static class GameSettings
{
    ...
    {
        return SetBool(key, 0 != PlayerPrefs.GetInt(key + "_BOOL", defaultValue ? 1 : 0));
    }
    public static bool GetBool(string key, ref bool value)
    {
        return value = GetBool(key, value);
    }
    ...
    {
        return SetInt(key, PlayerPrefs.GetInt(key + "_INT", defaultValue));
    }
    public static int GetInt(string key, ref int value)
    {
        return value = GetInt(key, value);
    }
    ...
    {
        return SetUint(key, (uint)PlayerPrefs.GetInt(key + "_UINT", (int)defaultValue));
    }
    public static uint GetUint(string key, ref uint value)
    {
        return value = GetUint(key, value);
    }
    ...
    {
        return SetFloat(key, PlayerPrefs.GetFloat(key + "_FLOAT", defaultValue));
    }
    public static float GetFloat(string key, ref float value)
    {
        return value = GetFloat(key, value);
    }
    ...
    {
        return SetString(key, PlayerPrefs.GetString(key + "_STRING", defaultValue));
    }
    public static string GetString(string key, ref string value)
    {
        return value = GetString(key, value);
    }
    ...
    {
        return SetChar(key, (char)PlayerPrefs.GetInt(key + "_CHAR", defaultValue));
    }
    public static char GetChar(string key, ref char value)
    {
        return value = GetChar(key, value);
    }
    ...
    {
        return value = GetColor(key, value);
    }
    ...
    public static Vector3 GetVector3(string key, ref Vector3 value)
    {
        return value = GetVector3(key, value);
    }
    ...
    public static Vector2 GetVector2(string key, ref Vector2 value)
    {
        return value = GetVector2(key, value);
    }
    ...
    public static Quaternion GetQuaternion(string key, ref Quaternion value)
    {
        return value = GetQuaternion(key, value);
    }
