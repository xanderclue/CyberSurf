...
{
    private bool gamepadEnabled = false, playerMovementLocked = true, debugSpeedEnabled;

    private SpatialData gyro;
    private Rigidbody playerRigidbody;
    private ManagerClasses.RoundTimer roundTimer;

    private float pitch, yaw, gyroPrevPitch, newAcceleration, currAcceleration, debugSpeedIncrease;
    ...
    //updates our movement variables based on a BoardType
    ...
    IEnumerator GyroMovementCoroutine()
    {
        ...
        pitch = (float)gyro.rollAngle * Mathf.Rad2Deg * movementVariables.pitchSensitivity;
